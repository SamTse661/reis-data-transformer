...
export const assessmentTransformer = (tableCode, processTimestamp) => {
...
export const assessmentSqlGenerator = (tableCode, processTimestamp) => {
  ...
  for (const row of transformedData) {
    ...
    row.int_assessment_is_del = row.int_assessment_is_del == 1;
  }
