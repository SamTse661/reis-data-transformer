...
export const bdDloInspectionTransformer = (tableCode, processTimestamp) => {
...
export const bdDloInspectionSqlGenerator = (tableCode, processTimestamp) => {
  ...
  for (const row of transformedData) {
    ...
    row.int_property_pre_war_building_dlo = row.int_property_pre_war_building_dlo == 1;
    row.int_property_size_larger = row.int_property_size_larger == 1;
    row.int_property_additional_storey = row.int_property_additional_storey == 1;
    row.int_property_joint_staircase = row.int_property_joint_staircase == 1;
    row.int_property_resite_village = row.int_property_resite_village == 1;
  }
